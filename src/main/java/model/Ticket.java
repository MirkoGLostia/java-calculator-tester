...
public class Ticket {
    ...
    public Ticket(double distance, int agePassenger) throws IllegalArgumentException {
    ...
    public double getPrice() {
        if (agePassenger < 18) {
            return getFullPrice() - (getFullPrice() * DISCOUNT_MINOR);
        } else if (agePassenger > 65) {
            return getFullPrice() - (getFullPrice() * DISCOUNT_ELDERLY);
        } else {
            return getFullPrice();
        }
    }
